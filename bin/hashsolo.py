...
parser.add_argument('--clustering_data', help='input directory containing transcriptomic data in 10x mtx format.', type=str, default=None)
...
param_list = [['hto_data', args.hto_data], ['prior_negative', args.priors[0]], ['prior_singlet', args.priors[1]], ['prior_doublet', args.priors[2]], ['pre_existing_clusters', args.pre_existing_clusters], ['clustering_data', args.clustering_data], ['number_of_noise_barcodes', args.number_of_noise_barcodes]]
